...
I was building this blog/website and decided to implement an animation I kept seeing around the interwebz where the elements animate as they're scrolled into the viewport. Well, there's a few ways to do this so I decided to go with the easiest way possible (don't reinvent the wheel, amirite).
...
*this assumes you're using React*
